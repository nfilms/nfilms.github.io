...
(function($) {
    ...
    jQuery( document ).ready(function ($) {
        ...
        var mapGoogle = {
            $wrap: $( '#map-canvas' ),
            init: function () {
                var $lati = this.$wrap.attr( 'data-lat' ),
                    $longi = this.$wrap.attr( 'data-long' ), 
                    map = { };
        ...
        $( ' a[href*=#].to-top' ).on("click", function ( e ) {
            var anchor = $( this );
        ...
        $( ".nav.navbar-nav  li.dropdown a" ).on("click", function () {
            $( ".nav.navbar-nav   li.dropdown a.dropdown-toogle" ).removeClass( "active" );
            $( this ).toggleClass( "active" );
        });

        $( ".nav.navbar-nav  li.dropdown a.active + ul.dropdown-menu li.dropdown a" ).on("click", function ( none ) {
        ...
        // Contact form
        if (jQuery('.contacts-forms').size() > 0) {
